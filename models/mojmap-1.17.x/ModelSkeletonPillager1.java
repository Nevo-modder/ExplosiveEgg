...
public class ModelSkeletonPillager1<T extends Entity> extends EntityModel<T> {
	...
	public SkeletonPillager(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LEFTHAND = partdefinition.addOrReplaceChild("LEFTHAND",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(6.0F, 9.0F, -33.0F, 2.0F, 2.0F, 39.0F, new CubeDeformation(0.0F)).texOffs(41, 41)
		...
		PartDefinition RIGHTHAND = partdefinition.addOrReplaceChild("RIGHTHAND", CubeListBuilder.create().texOffs(0, 41)
				.addBox(-9.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition HEAD = partdefinition.addOrReplaceChild("HEAD",
				CubeListBuilder.create().texOffs(43, 0)
						.addBox(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(25, 25)
						.addBox(-1.0F, -3.0F, -5.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
