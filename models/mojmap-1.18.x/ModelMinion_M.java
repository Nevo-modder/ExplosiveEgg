...
public class ModelMinion_M<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "minion_m"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -8.0F, -1.5F, 8.0F, 8.0F, 8.0F,
		...
		PartDefinition cube_r2 = leg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 21).addBox(-2.0F, 0.25F, -0.25F, 3.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(-4.0F, -25.0F, -0.5F, 7.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(24, 0)
						...
						.addBox(-6.0F, -16.0F, 0.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(17, 18)
						.addBox(-2.0F, -23.0F, -0.5F, 3.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)),
