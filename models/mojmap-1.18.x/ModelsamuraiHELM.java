	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, -1.0F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(24, 24)
		...
		PartDefinition Head_r1 = Head
				.addOrReplaceChild("Head_r1",
						CubeListBuilder.create().texOffs(6, 0).addBox(-2.75F, -3.0F, -5.0F, 2.0F, 3.0F, 1.0F,
		...
		PartDefinition Head_r4 = Head.addOrReplaceChild("Head_r4",
				CubeListBuilder.create().texOffs(58, 11).addBox(0.0F, -1.0F, 0.0F, 4.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r8 = Head.addOrReplaceChild("Head_r8",
				CubeListBuilder.create().texOffs(58, 14).addBox(-2.0F, -1.0F, -0.25F, 4.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r10 = Head.addOrReplaceChild("Head_r10",
				CubeListBuilder.create().texOffs(2, 24).addBox(-1.0F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, -3.0F, -6.0F, 0.0F, 0.0F, 0.2182F));
		...
		PartDefinition Head_r12 = Head
				.addOrReplaceChild("Head_r12",
						CubeListBuilder.create().texOffs(0, 0).addBox(-0.25F, -3.0F, -5.0F, 2.0F, 3.0F, 1.0F,
								new CubeDeformation(0.0F)),
