...
public class ModelZombieMobs2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "zombiemobs2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 37)
						.addBox(-4.0F, 0.0F, 2.0F, 8.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 11)
		...
		PartDefinition Body_r7 = Body.addOrReplaceChild("Body_r7",
				CubeListBuilder.create().texOffs(30, 0).addBox(-1.0F, -15.0F, -3.0F, 2.0F, 3.0F, 1.0F,
		...
		PartDefinition Body_r1_r1 = Body_r1.addOrReplaceChild("Body_r1_r1",
				CubeListBuilder.create().texOffs(52, 20).addBox(5.5377F, -15.585F, -6.2575F, 5.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r2_r1 = Body_r2.addOrReplaceChild("Body_r2_r1",
				CubeListBuilder.create().texOffs(52, 5).addBox(-5.3411F, -15.3847F, -5.1944F, 5.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r3_r1 = Body_r3.addOrReplaceChild("Body_r3_r1",
				CubeListBuilder.create().texOffs(0, 60).addBox(-4.0F, -13.0F, 9.85F, 8.0F, 7.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Rleg = partdefinition.addOrReplaceChild("Rleg",
				CubeListBuilder.create().texOffs(36, 19)
						.addBox(-3.0F, 11.0F, -3.0F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 20)
		...
		PartDefinition Lleg = partdefinition.addOrReplaceChild("Lleg",
				CubeListBuilder.create().texOffs(24, 11)
						.addBox(-2.0F, 8.0F, -3.0F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(36, 67)
		...
		PartDefinition Helmet = partdefinition.addOrReplaceChild("Helmet",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-5.0F, -9.0F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(12, 75)
		...
		PartDefinition cube_r15 = Helmet.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(2, 24).addBox(0.0F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -11.0F, -6.0F, 0.0F, 0.0F, 0.2182F));

		PartDefinition cube_r16 = Helmet.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(8, 24).addBox(-1.0F, -1.0F, 0.0F, 1.0F, 3.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = Helmet.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(0, 24).addBox(0.0F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, -11.0F, -6.0F, 0.0F, 0.0F, -0.2182F));

		PartDefinition cube_r18 = Helmet.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(6, 24).addBox(0.0F, -1.0F, 0.0F, 1.0F, 3.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Rhand = Hands.addOrReplaceChild("Rhand", CubeListBuilder.create().texOffs(52, 13).mirror()
				.addBox(-4.0F, 9.0F, -2.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(46, 0)
				.mirror().addBox(-3.0F, 12.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(58, 0).mirror().addBox(-3.0F, 9.0F, -3.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(43, 58).mirror()
				.addBox(-3.0F, 9.0F, 2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(24, 14)
				.mirror().addBox(-3.0F, 0.0F, -2.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(33, 58).mirror().addBox(-4.0F, 0.0F, -3.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(20, 53).mirror()
				...
				.addBox(-3.0F, 3.0F, 2.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(57, 57)
				.mirror().addBox(-4.0F, 0.0F, 2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(18, 14).mirror().addBox(0.0F, 0.0F, 2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				.mirror(false).texOffs(12, 14).mirror()
				.addBox(0.0F, 0.0F, -3.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(48, 41)
				.mirror().addBox(-2.0F, -1.0F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(20, 59).addBox(-3.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, 2.5F, 1.5F, -1.0612F, -0.1323F, -0.1435F));

		PartDefinition cube_r27 = Rhand.addOrReplaceChild("cube_r27",
		...
		PartDefinition cube_r28 = Rhand.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(24, 51).mirror()
		...
		PartDefinition cube_r29 = Rhand.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(14, 51).mirror()
						.addBox(0.0F, -1.0F, -1.0F, 1.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.0F, -1.0F, -1.0F, 0.0F, 0.0F, 0.8727F));

		PartDefinition cube_r30 = Rhand.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(56, 34).mirror()
		...
		PartDefinition cube_r31 = Rhand.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(56, 32).mirror()
						.addBox(-4.0F, -7.0F, 1.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 7.0F, 3.0F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r32 = Rhand.addOrReplaceChild("cube_r32",
				CubeListBuilder.create().texOffs(54, 52).mirror()
						.addBox(-4.0F, -7.0F, 1.0F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 5.0F, -6.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r33 = Rhand.addOrReplaceChild("cube_r33",
		...
		PartDefinition sword = Hands.addOrReplaceChild("sword",
				CubeListBuilder.create().texOffs(0, 92)
						.addBox(-1.0F, 7.0F, -13.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(49, 91)
		...
		PartDefinition Lhand = Hands.addOrReplaceChild("Lhand",
				CubeListBuilder.create().texOffs(52, 13)
						.addBox(3.0F, 9.0F, -2.0F, 1.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(46, 0)
						...
						.addBox(-1.0F, -1.0F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(20, 59)
		...
		PartDefinition cube_r1 = Lhand.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 11).addBox(-1.0F, -2.0F, -1.0F, 1.0F, 5.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 4.0F, -1.0F, 0.0F, 0.0F, -0.3491F));

		PartDefinition cube_r2 = Lhand.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(24, 51).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 1.0F, -1.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r3 = Lhand.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(14, 51).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -1.0F, -1.0F, 0.0F, 0.0F, -0.8727F));

		PartDefinition cube_r4 = Lhand
				.addOrReplaceChild("cube_r4",
						CubeListBuilder.create().texOffs(56, 34).addBox(-1.0F, -7.0F, 1.0F, 5.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 6.0F, 3.0F, 0.3491F, 0.0F, 0.0F));

		PartDefinition cube_r5 = Lhand
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(56, 32).addBox(-1.0F, -7.0F, 1.0F, 5.0F, 1.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 7.0F, 3.0F, 0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r6 = Lhand.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(54, 52).addBox(-1.0F, -7.0F, 1.0F, 5.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 5.0F, -6.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r7 = Lhand.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 32).addBox(-1.0F, -7.0F, 1.0F, 4.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 6.0F, -6.0F, -0.3491F, 0.0F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(33, 91)
						.addBox(0.0F, -25.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 91)
						.addBox(-4.0F, -25.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
