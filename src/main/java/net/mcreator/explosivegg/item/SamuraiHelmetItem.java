...
public abstract class SamuraiHelmetItem extends ArmorItem {
	public SamuraiHelmetItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends SamuraiHelmetItem {
		public Helmet() {
		...
		public void initializeClient(java.util.function.Consumer<net.minecraftforge.client.IItemRenderProperties> consumer) {
			consumer.accept(new IItemRenderProperties() {
				...
				public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("body",
									new ModelBodySamurai(Minecraft.getInstance().getEntityModels().bakeLayer(ModelBodySamurai.LAYER_LOCATION)).body,
									"left_arm",
									new ModelBodySamurai(Minecraft.getInstance().getEntityModels().bakeLayer(ModelBodySamurai.LAYER_LOCATION)).Lhand,
									"right_arm",
									new ModelBodySamurai(Minecraft.getInstance().getEntityModels().bakeLayer(ModelBodySamurai.LAYER_LOCATION)).Rhand,
		...
		public void initializeClient(java.util.function.Consumer<net.minecraftforge.client.IItemRenderProperties> consumer) {
			consumer.accept(new IItemRenderProperties() {
				...
				public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("left_leg",
									new ModelBootsSamurai(Minecraft.getInstance().getEntityModels().bakeLayer(ModelBootsSamurai.LAYER_LOCATION)).Lleg,
									"right_leg",
									new ModelBootsSamurai(Minecraft.getInstance().getEntityModels().bakeLayer(ModelBootsSamurai.LAYER_LOCATION)).Rleg,
									"head", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "hat",
