...
public class FireballKeyBinding extends ExplosiveggModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public FireballKeyBinding(ExplosiveggModElements instance) {
		super(instance, 21);
	...
	public void initElements() {
		keys = new KeyBinding("key.explosivegg.fireball", GLFW.GLFW_KEY_UP, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			BkeyProcedure.executeProcedure(Stream
