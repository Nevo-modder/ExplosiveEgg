...
public class LightninKeyBinding extends ExplosiveggModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public LightninKeyBinding(ExplosiveggModElements instance) {
		super(instance, 44);
	...
	public void initElements() {
		keys = new KeyBinding("key.explosivegg.lightnin", GLFW.GLFW_KEY_RIGHT, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			LKeyProcedure.executeProcedure(Stream
