...
public class MinionKeyKeyBinding extends ExplosiveggModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public MinionKeyKeyBinding(ExplosiveggModElements instance) {
		super(instance, 49);
	...
	public void initElements() {
		keys = new KeyBinding("key.explosivegg.minion_key", GLFW.GLFW_KEY_LEFT, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			MinionProcedureProcedure.executeProcedure(Stream
