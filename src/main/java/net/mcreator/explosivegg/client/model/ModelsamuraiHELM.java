...
public class ModelsamuraiHELM<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hat = partdefinition.addOrReplaceChild("Hat",
				CubeListBuilder.create().texOffs(36, 122).addBox(-4.0F, -8.0F, -5.0F, 8.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 93)
		...
		PartDefinition Head_r1 = Hat.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(0, 85).addBox(-0.25F, -3.0F, -5.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.0F, -3.0F, 0.0F, 0.0F, 0.0F, -0.3491F));
		PartDefinition Head_r2 = Hat.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(8, 109).addBox(-1.0F, -1.0F, 0.0F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -9.0F, -6.0F, -0.1745F, -0.0436F, 0.9599F));
		PartDefinition Head_r3 = Hat.addOrReplaceChild("Head_r3",
				CubeListBuilder.create().texOffs(2, 109).addBox(-1.0F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, -11.0F, -6.0F, 0.0F, 0.0F, 0.2182F));
		PartDefinition Head_r4 = Hat.addOrReplaceChild("Head_r4",
				CubeListBuilder.create().texOffs(6, 109).addBox(0.0F, -1.0F, 0.0F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -9.0F, -6.0F, -0.1745F, -0.0436F, -0.9599F));
		PartDefinition Head_r5 = Hat.addOrReplaceChild("Head_r5",
				CubeListBuilder.create().texOffs(58, 99).addBox(-2.0F, -1.0F, -0.25F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -8.0F, -6.0F, -0.2182F, 0.0F, 0.0F));
		PartDefinition Head_r6 = Hat.addOrReplaceChild("Head_r6",
				CubeListBuilder.create().texOffs(0, 109).addBox(0.0F, -2.0F, 0.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, -11.0F, -6.0F, 0.0F, 0.0F, -0.2182F));
		PartDefinition Head_r7 = Hat.addOrReplaceChild("Head_r7",
				CubeListBuilder.create().texOffs(12, 99).addBox(-1.0F, -1.0F, -5.0F, 1.0F, 3.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, -5.0F, 0.0F, 0.0F, 0.0F, 0.384F));
		PartDefinition Head_r8 = Hat.addOrReplaceChild("Head_r8",
				CubeListBuilder.create().texOffs(58, 93).addBox(-4.0F, -1.0F, 0.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0F, -5.0F, -0.9948F, 0.0F, 0.1309F));
		PartDefinition Head_r9 = Hat.addOrReplaceChild("Head_r9",
				CubeListBuilder.create().texOffs(0, 96).addBox(-1.0F, -1.0F, -5.0F, 1.0F, 3.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, -5.0F, 0.0F, 0.0F, 0.0F, -0.384F));
		PartDefinition Head_r10 = Hat.addOrReplaceChild("Head_r10",
				CubeListBuilder.create().texOffs(58, 96).addBox(0.0F, -1.0F, 0.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0F, -5.0F, -0.9948F, 0.0F, -0.1309F));
		PartDefinition Head_r11 = Hat.addOrReplaceChild("Head_r11",
				CubeListBuilder.create().texOffs(18, 122).addBox(-4.0F, -3.0F, 0.0F, 8.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.0F, 5.0F, 0.2182F, 0.0F, 0.0F));
		PartDefinition Head_r12 = Hat.addOrReplaceChild("Head_r12",
				CubeListBuilder.create().texOffs(6, 85).addBox(-2.75F, -3.0F, -5.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
