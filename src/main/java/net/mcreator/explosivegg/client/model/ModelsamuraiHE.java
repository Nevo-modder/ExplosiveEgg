...
public class ModelsamuraiHE<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("explosivegg", "modelsamurai_he"), "main");
	public final ModelPart Head;

	public ModelsamuraiHE(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, 7.0F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(24, 24)
		...
		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1",
				...
				PartPose.offsetAndRotation(-5.0F, 13.0F, 0.0F, 0.0F, 0.0F, 0.3491F));
		PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2",
				...
				PartPose.offsetAndRotation(0.0F, 11.0F, 5.0F, 0.2182F, 0.0F, 0.0F));
		PartDefinition Head_r3 = Head.addOrReplaceChild("Head_r3",
				...
				PartPose.offsetAndRotation(5.0F, 11.0F, 0.0F, 0.0F, 0.0F, -0.384F));
		PartDefinition Head_r4 = Head.addOrReplaceChild("Head_r4",
				...
				PartPose.offsetAndRotation(0.0F, 11.0F, -5.0F, -0.9948F, 0.0F, -0.1309F));
		...
		PartDefinition Head_r6 = Head.addOrReplaceChild("Head_r6",
				...
				PartPose.offsetAndRotation(-4.0F, 11.0F, 0.0F, 0.0F, 0.0F, 0.384F));
		PartDefinition Head_r7 = Head.addOrReplaceChild("Head_r7",
				...
				PartPose.offsetAndRotation(-4.0F, 5.0F, -6.0F, 0.0F, 0.0F, -0.2182F));
		...
		PartDefinition Head_r9 = Head.addOrReplaceChild("Head_r9",
				...
				PartPose.offsetAndRotation(-3.0F, 7.0F, -6.0F, -0.1745F, -0.0436F, -0.9599F));
		...
		PartDefinition Head_r12 = Head.addOrReplaceChild("Head_r12",
				...
				PartPose.offsetAndRotation(6.0F, 13.0F, 0.0F, 0.0F, 0.0F, -0.3491F));
