...
public class MasterOfTheFiveMagics4Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (Master4Procedure.execute(world, entity)) {
				...
				RenderSystem.setShaderTexture(0, new ResourceLocation("explosivegg:textures/screens/light.png"));
				Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + 117, posY + -62, 0, 0, 128, 128, 128, 128);
