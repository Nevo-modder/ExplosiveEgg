...
public class MasterOfTheFiveMagics3Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (Master3Procedure.execute(world, entity)) {
				...
				Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + 165, posY + -109, 0, 0, 178, 179, 178, 179);
				...
				Minecraft.getInstance().gui.blit(event.getMatrixStack(), posX + 117, posY + -109, 0, 0, 128, 128, 128, 128);
