...
import net.mcreator.explosivegg.entity.renderer.ZombieSamuraiRenderer;
import net.mcreator.explosivegg.ExplosiveggModElements;

@ExplosiveggModElements.ModElement.Tag
public class ZombieSamuraiEntity extends ExplosiveggModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("zombie_samurai").setRegistryName("zombie_samurai");

	public ZombieSamuraiEntity(ExplosiveggModElements instance) {
		super(instance, 31);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ZombieSamuraiRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092544, -16738048, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("zombie_samurai_spawn_egg"));
	}
	...
	public static class CustomEntity extends ZombieEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(KatanaItem.block));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(SamuraiHelmetItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(SamuraiHelmetItem.body));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(SamuraiHelmetItem.boots));
		}
