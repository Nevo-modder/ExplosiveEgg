...
@OnlyIn(Dist.CLIENT)
public class ZombieSamuraiRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ZombieSamuraiEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelZombieMobs(), 0.5f) {
