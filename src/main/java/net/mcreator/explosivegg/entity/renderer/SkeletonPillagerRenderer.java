...
@OnlyIn(Dist.CLIENT)
public class SkeletonPillagerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SkeletonPillagerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelSkeletonPillager3(), 0.5f) {
